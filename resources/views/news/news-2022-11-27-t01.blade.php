...
<header class="site-header site-news-2022-11-27-t01-header">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-10 col-12 mx-auto">
				...
				<strong style="background-color: aliceblue;padding: 12px;">{{ __('news.date-2022-11-27') }}</strong>
				<h5 class="text-white my-font">{{ __('news.news-2022-11-27-t01-header') }}</h5>
			</div>
...
<section class="about section-padding bg-white">
	<div class="container">
		<div class="row my-header-row">
			<div class="col">
				<h2 class="text-center my-header">{{ __('news.news-2022-11-27-t01-header') }}</h2>
			</div>
		</div>

		<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-6">
				<img src="assets/images/news/news-2022-11-27.jpg" class="img-fluid" alt="" width=100% style="margin:10px;">
				<img src="assets/images/news/news-2022-11-27-2.jpg" class="img-fluid" alt="" width=100% style="margin:10px;">
			</div>
			<div class="col-sm-12 col-md-12 col-lg-6">
				<p class="my-p">{{ __('news.news-2022-11-27-t01-body') }}</p>
			</div>
		</div>
	</div>
</section>
