		...
		<div class="modal-dialog modal-dialog-centered modal-xl">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="mb-0">{{ __('apply.join-us') }}</h3>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body d-flex flex-column justify-content-center">
					<p class="my-p">{{ __('apply.header') }}</p>
					<div class="booking">
						<form class="booking-form row" role="form" action="#" method="post">
							
							<div class="col-12">
								<label for="name" class="form-label">{{ __('apply.title') }}</label>
								<select class="form-select form-control applySelectedStyle">
									<option>{{ __('apply.choose') }}</option>
									<option value="5">{{ __('apply.choose-dr') }}</option>
									<option value="6">{{ __('apply.choose-professor') }}</option>
									<option value="7">{{ __('apply.choose-expert') }}</option>
									<option value="4">{{ __('apply.choose-mr') }}</option>
									<option value="3">{{ __('apply.choose-miss') }}</option>
									<option value="2">{{ __('apply.choose-mrs') }}</option>
								</select>
							</div>
							<div class="col-lg-6 col-12">
								<label for="name" class="form-label">{{ __('apply.first-name') }}</label>
								<input type="text" name="name" id="name" class="form-control"
									placeholder="{{ __('apply.first-name') }}" required>
							</div>
							<div class="col-lg-6 col-12">
								<label for="name" class="form-label">{{ __('apply.last-name') }}</label>
								<input type="text" name="name" id="name" class="form-control"
									placeholder="{{ __('apply.last-name') }}" required>
							</div>
							<div class="col-lg-6 col-12">
								<label for="email" class="form-label">{{ __('apply.email') }}</label>
								<input type="email" name="email" id="email" pattern="[^ @]*@[^ @]*"
									class="form-control" placeholder="your@email.com" required>
							</div>
							<div class="col-lg-6 col-12">
								<label for="phone" class="form-label">{{ __('apply.phone') }}</label>
								<input type="telephone" name="phone" id="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"
									class="form-control" placeholder="123-456-7890">
							</div>

							<div class="col-6">
								<label for="name" class="form-label">{{ __('apply.sector') }}</label>
								<select class="form-select form-control applySelectedStyle">
									<option>{{ __('apply.choose') }}</option>
									<option value="1">{{ __('apply.classifier-01') }}</option>
									<option value="2">{{ __('apply.classifier-02') }}</option>
									<option value="3">{{ __('apply.classifier-03') }}</option>
									<option value="4">{{ __('apply.classifier-04') }}</option>
									<option value="5">{{ __('apply.classifier-05') }}</option>
									<option value="6">{{ __('apply.classifier-06') }}</option>
									<option value="7">{{ __('apply.classifier-07') }}</option>
									<option value="8">{!! __('apply.classifier-08') !!}</option>
									<option value="9">{{ __('apply.classifier-09') }}</option>
									<option value="10">{{ __('apply.classifier-10') }}</option>
									<option value="11">{{ __('apply.classifier-11') }}</option>
									<option value="12">{{ __('apply.classifier-12') }}</option>
									<option value="13">{{ __('apply.classifier-13') }}</option>
									<option value="14">{{ __('apply.classifier-14') }}</option>
									<option value="15">{{ __('apply.classifier-15') }}</option>
									<option value="16">{{ __('apply.classifier-16') }}</option>
									<option value="17">{{ __('apply.classifier-17') }}</option>
									<option value="18">{{ __('apply.classifier-18') }}</option>
									<option value="19">{{ __('apply.classifier-19') }}</option>
									<option value="20">{{ __('apply.classifier-20') }}</option>
									<option value="21">{{ __('apply.classifier-21') }}</option>
									<option value="22">{{ __('apply.classifier-22') }}</option>
								</select>
							</div>

							<div class="col-6">
								<label for="name" class="form-label">{{ __('apply.work-experience') }}</label>
								<select class="form-select form-control applySelectedStyle">
									<option>{{ __('apply.choose') }}</option>
									<option value="2">{{ __('apply.work-experience-1') }}</option>
									<option value="3">{{ __('apply.work-experience-2') }}</option>
									<option value="4">{{ __('apply.work-experience-3') }}</option>
									<option value="5">{{ __('apply.work-experience-4') }}</option>
								</select>
							</div>

							<div class="col-6">
								<label for="name" class="form-label">{{ __('apply.language') }}</label>
								<select class="form-select form-control form-control applySelectedStyle">
									<option>{{ __('apply.choose') }}</option>
									<option value="english">{{ __('apply.language-english') }}</option>
									<option value="russian">{{ __('apply.language-russian') }}</option>
									<option value="uzbek">{{ __('apply.language-uzbek') }}</option>
								</select>
							</div>

							<div class="col-6">
								<label for="name" class="form-label">{{ __('apply.citizenship') }}</label>
								<select class="form-select form-control applySelectedStyle">
									<option>{{ __('apply.choose') }}</option>
